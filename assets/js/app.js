(function () {
  ...
  const CONFIG = {
    ...
    // المواقيت تُحسب فلكيًا لهذه الإحداثيات. فجر ١٨° وعشاء ١٨°: مرجع كرم يعطي
    // العشاء 20:05 في ١٧ أيلول ٢٠٢٦، وهو ما تعطيه ١٨° لا ١٧° (20:01).
    prayerMethod: { fajrAngle: 18, ishaAngle: 18 },
    ...
    // دقائق تُضاف على الحساب لكل صلاة. صفر = الوقت الفلكي كما هو.
    // المغرب +7: مرجع المدرسة يعطي 18:50 في ١٧ أيلول ٢٠٢٦ والغروب الفلكي
    // 18:43 — احتياط معتاد في جداول المنطقة؛ بقية الصلوات طابقت الحساب صرفًا.
    offsets: {
      Fajr: 0,
      Sunrise: 0,
      Dhuhr: 0,
